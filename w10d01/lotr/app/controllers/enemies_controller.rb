class EnemiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @enemy.save
        format.html { redirect_to enemy_url(@enemy), notice: "Enemy was successfully created." }
  ...
  def update
    respond_to do |format|
      if @enemy.update(enemy_params)
        format.html { redirect_to enemy_url(@enemy), notice: "Enemy was successfully updated." }
